                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Online Exam Placement System</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="Seating.php" method="post">
                                	<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="matricno" placeholder="Enter Your Matric Number" autocomplete="off" name="matricno">
                                	</div>
                               <div class="form-group">
                                 <label for="default" class="control-label"> Student Name</label>
<select name="studentname" class="form-control" id="studentname" required="required">
<option value=""disabled  selected hidden>Select Your Name</option>
<?php $sql = "SELECT distinct StudentName from studentinfo";
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © <a href="https://www.linkedin.com/feed/">KHAIRY</a> 2018</small></p>
                    </div>
